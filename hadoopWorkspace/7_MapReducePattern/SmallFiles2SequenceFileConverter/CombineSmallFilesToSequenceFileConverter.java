...
public class CombineSmallFilesToSequenceFileConverter extends Configured implements Tool {
  ...
  public int run(String[] args) throws Exception {
    ...
    conf.setJobName("Combined Small files 2 SequenceFile");
    conf.setJar("cs2sf.jar");
  ...
  public static void main(String[] args) throws Exception {
    // TODO Auto-generated method stub
    int exitCode = ToolRunner.run(new CombineSmallFilesToSequenceFileConverter(), args);
